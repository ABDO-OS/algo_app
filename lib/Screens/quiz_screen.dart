...
class _QuizScreenState extends State<QuizScreen> {
  ...
  final List<Question> questions = [
    ...
    Question(
      questionText:
          "Tradeoffs in algorithm efficiency often involve balancing:",
      options: [
    ...
    Question(
      questionText:
          "An algorithm that prioritizes storage capacity may lead to:",
      options: [
    ...
    Question(
      questionText:
          "Algorithm A executes T(n) = 2n^2 + 1000 n elementary operations while algorithm B executes T(n) = 0.1n^2 + 100 elementary operations, which of the following sentence is correct",
      options: [
    ...
    Question(
      questionText:
          "Sort the following function in order of increasing growth rate? 1 N² 2 Nlog(N) 3 2N 4 C 5 N!",
    ...
    Question(
      questionText:
          "for i = 0 to n do P(i); for j = 0 to n do P(j); if P takes time T where T is independent of i and j so the running time of the algorithm is",
    ...
    Question(
      questionText:
          "Four Algorithms A1, A2, A3, A4 solver a problem with the following growth rates in order respectively, Which is best algorithm? 3n²+2n, nlogn+9, n³ logn+4, 5n² +3",
      options: ["A1", "A2", "A3", "A4"],
      correctAnswerIndex: 1,
    ),
    Question(
    ...
    Question(
      questionText:
          "Which of the given options provides the increasing order of asymptotic complexity of functions f1, f2, f3, and f4? f1(n) = 2n f2(n) = n³/2 f3(n) = log(n) f4(n) = nlog(n)",
      options: [
        "f3, f4, f1, f2",
        "f3, f1, f4, f2",
        "f2, f3, f1, f4",
    ...
    Question(
      questionText:
          "What is the Big-Oh? function fun(n): count = 0 for i from n to 1 by i divided by 2: for j from 0 to i: count += 1 return count",
      options: ["O(n2)", "O(n*log(n))", "O(n)", "O(1)"],
      correctAnswerIndex: 1,
    ),
    Question(
      questionText:
          "What is the Big-Oh? void fun(int n, int arr[]) { int i = 0, j = 0; for (; i < n; ++i) while (j < n && arr[i] < arr[j]) j++; }",
    ...
    Question(
      questionText:
          "What is time complexity for performing the following operations on a linked list? 1. Insert or remove a new element at current position: O(1) O(n) O(n^2) All of the above.",
      options: ["O(1)", "O(n)", "O(n^2)", "All of the above"],
      correctAnswerIndex: 0,
    ),
    Question(
      questionText:
          "What is time complexity for performing the following operations on a linked list? 2. Access elements by index: O(1) O(n) O(n^2) All of the above.",
      options: ["O(1)", "O(n)", "O(n^2)", "All of the above"],
      correctAnswerIndex: 1,
    ),
    Question(
      questionText:
          "Calculating the Running Time for a Program for (i=1; i<=n; i++) num +=i*i;",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(1)"],
      correctAnswerIndex: 0,
    ),
    Question(
      questionText:
          "Pseudocode : List_sum(A,n) { sum =0 for i=0 to n-1 sum += A[i] return sum } What is time Complexity of the Above Code ?",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(1)"],
      correctAnswerIndex: 0,
    ),
    Question(
      questionText:
          "What is the time complexity of the following code: for(int i=1; i<n; i++){ //some expression }",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(1)"],
      correctAnswerIndex: 0,
    ),
    Question(
    ...
    Question(
      questionText:
          "What is the time complexity of the following code: int a = 0, b = 0; for (i = 0; i < N; i++) { a = a + Math.random(); } for (j = 0; j < M; j++) { b = b + Math.random(); }",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(1)"],
      correctAnswerIndex: 0,
    ),
    Question(
    ...
    Question(
      questionText:
          "What is the time complexity of the following code: sum = 0; for (i=0; i<3; i++) for (j=0; j<n; j++) sum++;",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(1)"],
      correctAnswerIndex: 0,
    ),
    Question(
      questionText:
          "What is the time complexity of the following code: static int search(int arr[], int n, int x) { int i; for (i = 0; i < n; i++) { if (arr[i] == x) { return i; } } return -1; }",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(1)"],
      correctAnswerIndex: 0,
    ),
    Question(
      questionText:
          "What is the time complexity of the following code: sum = 0; for (i=1; i<=n; i++) for (j=1; j<=n; j*=2) sum++;",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(n log n)"],
      correctAnswerIndex: 3,
    ),
    Question(
      questionText:
          "What is the time complexity of the following code: sum=0; for (i=0; i<n*n; i++) sum++;",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(1)"],
      correctAnswerIndex: 1,
    ),
    Question(
      questionText:
          "What is the time complexity of the following code: a = b + c; d = a + e;",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(1)"],
      correctAnswerIndex: 3,
    ),
    Question(
      questionText:
          "What is the time complexity of the following code: procedure who_knows(a1, a2, ..., an: integers) m := 0 for i := 1 to n-1 for j := i + 1 to n if |ai−aj| > m then m := |ai−aj|",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(1)"],
      correctAnswerIndex: 1,
    ),
    Question(
    ...
    Question(
      questionText:
          "Assume that P(j) takes time t, where t is independent of i and j, How do we analyze the running time of an algorithm that has complex nested loop? for i = 0 to n do for j = 0 to i do P(j);",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(n log n)"],
      correctAnswerIndex: 1,
    ),
    Question(
      questionText:
          "The computing time for this algorithm in terms on input size n is : n = read input from user sum = 0 i = 0 while i < n number = read input from user sum = sum + number i = i + 1 mean = sum / n",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(1)"],
      correctAnswerIndex: 0,
    ),
    Question(
      questionText:
          "The computing time for this algorithm in terms on input size n is : i=1 while (i<=10) i=i+1 i=1 while (i<=n) a=2+g i=i+1 if (i<=n) a=2 else a=3",
      options: ["O(n)", "O(n^2)", "O(log n)", "O(1)"],
      correctAnswerIndex: 0,
    ),
    Question(
  ...
  void _showCorrectAnswer() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(currentQuestion.isMCQ
